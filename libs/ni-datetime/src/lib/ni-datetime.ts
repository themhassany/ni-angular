...
export const Locales = {
    ...
    ps_AF: {
        ...
        daysNameMini: ['ی', 'د', 'س', 'چ', 'پ', 'ج', 'ش'],
        monthsName: ['وری', 'غويی', 'غبرگولی', 'چنگاښ', 'زمری', 'وږی', 'تله', 'لړم', 'سلواغه', 'ليندۍ', 'مرغومی', 'کب'],
        monthsNameShort: ['وری', 'غويی', 'غبرگولی', 'چنگاښ', 'زمری', 'وږی', 'تله', 'لړم', 'سلواغه', 'ليندۍ', 'مرغومی', 'کب'],
        ampm: ['س', 'ښ'],
        AMPM: ['سهار', 'ماښام'],
        today: 'نن',
        clear: 'پاک'
