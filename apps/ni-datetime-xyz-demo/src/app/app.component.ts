...
import { NiDatetimeLocale, NiJalaliDatetime, Locales, toTimezone } from 'ni-datetime';
import { NiDatetimePipeService } from 'ni-datetime-pipe';

@Component({
  selector: 'ni-datetime-demo-root',
...
export class AppComponent implements OnInit {
  ...
  constructor(private pipeService: NiDatetimePipeService) {
    ...
    setInterval(() => this.value2 = toTimezone(new Date(), 270), 1000);
  }
